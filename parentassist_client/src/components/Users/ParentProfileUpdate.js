...
function ParentProfileUpdate() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:9000/getParentData', { params: { user_child_id }});
    ...
    const handleGeneralData = async (e) => {
        ...
        try {
            const response = await axios.put('http://localhost:9000/Parentprofileupdate', { name, age, address, phone, user_child_id });
